...
const Projects: React.FC = () => {
    const projects = [
        ...
        {
            title: "makeupcherie",
            description: "Took off quickly after I posted about it on Reddit and Instagram where it got 7 million+ views. The website gets roughly 30k unique visitors a month nowadays. I received a lot of valuable feedback which I used to improve it, and learnt a lot about marketing+SEO!",
            link: "https://makeupcherie.com",
            image: "/posts/makeupcherie-main.mov",
    ...
    return (
        <div className="flex flex-col w-full mb-[20vh]">
            ...
            <div className="flex flex-col items-center">
                <div className="w-[85%] sm:w-[42%]  xl:w-[35%] pt-[25vh] md:pt-[10vh]">
                    <h1 className="text-5xl  w-full lg:w-4/5 text-[#CA0079] font-newsreader mb-6 md:mb-10">
